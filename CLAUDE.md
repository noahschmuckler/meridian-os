...
0. **Launcher** — top-level "meridian" screen with iOS-style app icons. Cold boot lands here. Three apps today: **Mondrian GUI**, **Mentorship Tracker**, **Epic Quick Reference**. Selection persists across refresh. Future Scott-artifact apps that don't fit the bubble metaphor land here as additional icons.
